...
|优势    |可针对不同用户进行比较，如新用户/老客户/回头客，88+种语音调用可划分等级，特色发声人78人包括场景与声音年龄段筛选个性化，精品发声人5人，基础发声人5人免费，语速+音量，配备背景音乐符合词的个性，声音比腾讯AI好听，在换行之间不会讲得很快，有间隔来讲不像百度无间隔稍作停顿| |4种选择声音，语速+音调+音量| 腾讯AI Lab 和 腾讯优图，4种声音类型，音高+音量+音色+语速，在段落之间也就是换行间比百度要慢速一点，听得更加舒服，1男3女声，可利用情感来进行分析|未开放      |
|劣势    |250词限制，找不到文档就是按照上课流程来进行代码的调用|200字限制，很着急直接念完没有停顿，2男声2女声，代码开发文档还比较友好，甚至直接的调用代码都给到 GitHub 上直接修改参数调用就好，还是比较良心的|50字限制，在代码层次上语音合成只有PHP的代码没有pythn代码，官方压根没有合成示例文档，全自己摸索，SDK 都开发出来了，示例代码给一下能死，怪不得没人用。在合成效果上讲，声音难听爆了，语音文件还得解码再 I/O, 吃饱了撑的，怪不得没人用，百度语音合成效果比你强多了|未开放网页端，只有微信小程序体验版 网易 AI 体验中心，限制50字，语速只有正常慢速快速之分，没有API可以调用，没有文档|
