...
|v2.0|12.01-12.08|测试可用 API 并进行可用性测试比对，进行市场回访调查并做好相关用户研究|莫文俊|
|v3.0|12.08-12.15|选定 API 类型并实现测试运行，产品后台代码实现可复用并完善开发技术文档|莫文俊|
|v4.0|12.15-12.22|开发 APP 原型，制作低保真原型初步实现逻辑，对真实使用场景模拟使用测试|莫文俊|
|v5.0|12.23-12.30|产品上线并对产品使用过程中出现的问题不断反馈，针对需求池功能迭代优化|莫文俊|
